...
fun DependencyHandler.kotlinx(module: String, version: String? = null, prefix: Boolean = true): Any =
    "org.jetbrains.kotlinx:${if (prefix) "kotlinx-" else ""}$module${version?.let { ":$version" } ?: ""}"

fun DependencyHandler.serialization(module: String, version: String? = null): Any =
    "org.jetbrains.kotlinx:kotlinx-serialization-$module${version?.let { ":$version" } ?: ""}"
